        ...
        {isOpen && (
          ...
          >
            ...
            {!isMinimized && (
              <>
                {/* Messages Area */}
                <div className="flex-1 overflow-y-auto p-3 sm:p-4 md:p-5 space-y-3 sm:space-y-4 bg-gradient-to-b from-[#000]/5 via-white to-[#000]/5 dark:from-[#000]/10 dark:via-gray-900 dark:to-[#000]/10">
                  {/* Status Bar */}
