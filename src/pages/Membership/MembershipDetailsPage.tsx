...
export function MembershipDetailsPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8 lg:py-10 pb-24 lg:pb-10">
        ...
        >
          ...
          <div className="absolute -right-20 -top-20 h-48 w-48 sm:h-64 sm:w-64 rounded-full bg-[#0A3269]/5 blur-3xl" />
          ...
          <div className="relative flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 sm:gap-5 lg:gap-6">
            ...
            <div className="flex items-center gap-3 sm:gap-4 md:gap-5 w-full lg:w-auto">
              <div className={cn(
                ...
                selectedPlan.popular 
                  ? 'bg-gradient-to-br from-[#0A3269]/15 to-[#0A3269]/5 border-[#0A3269]/30' 
                ...
                <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                  ...
                  {selectedPlan.popular && (
                    <div className="relative">
                      <span className="absolute inset-0 rounded-full bg-[#0A3269]/40 animate-ping" />
                      <Badge className="relative bg-gradient-to-r from-[#0A3269] to-[#1A4A8A] text-white border-0 px-3 sm:px-4 py-1 text-[10px] sm:text-xs rounded-full shadow-md shadow-[#0A3269]/20">
            ...
            <Button
              ...
              className={cn(
                ...
                'bg-white text-[#0A3269] border-2 border-[#0A3269]/20 hover:border-[#0A3269]/40 shadow-lg hover:shadow-xl',
                selectedPlan.popular ? 'shadow-[#0A3269]/20' : 'shadow-gray-200 dark:shadow-gray-800'
              )}
            >
              {/* Shimmer Effect */}
              <span className="absolute inset-0 -translate-x-full group-hover/hero:translate-x-full transition-transform duration-700 bg-gradient-to-r from-transparent via-[#0A3269]/10 to-transparent" />
              
              {/* Subtle Glow on Hover */}
              <span className={cn(
                'absolute inset-0 opacity-0 group-hover/hero:opacity-100 transition-opacity duration-500 blur-xl',
                selectedPlan.popular ? 'bg-[#0A3269]/20' : 'bg-black/10 dark:bg-white/10'
              )} />
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-4">
              ...
              {selectedPlan.interval !== 'month' && (
                <span className="text-xs sm:text-sm text-[#0A3269] font-light">
        ...
        >
          <div className="flex items-center justify-between mb-4 sm:mb-5 md:mb-6">
            ...
            <Badge variant="outline" className="text-[9px] sm:text-[10px] font-light border-[#0A3269]/30 text-[#0A3269] rounded-full px-2.5 sm:px-3 py-0.5 sm:py-1 bg-[#0A3269]/5">
              {selectedPlan.label}
            </Badge>
          </div>
              ...
              return (
                <motion.div
                  ...
                  className={cn(
                    ...
                    selectedPlan.popular 
                      ? 'border-[#0A3269]/20 bg-gradient-to-br from-[#0A3269]/5 via-white/50 to-white dark:from-[#0A3269]/15 dark:via-black/50 dark:to-black' 
          ...
          <motion.div 
            ...
            className="mt-4 sm:mt-5 h-px bg-gradient-to-r from-transparent via-[#0A3269]/20 to-transparent"
          />
        </motion.div>
        ...
        >
          ...
          <div className="w-full overflow-x-auto rounded-xl sm:rounded-2xl border border-black/5 dark:border-white/5 bg-white/50 dark:bg-black/30 backdrop-blur-sm">
            <table className="w-full sm:min-w-full text-xs sm:text-sm">
              <thead>
                <tr className="border-b border-black/5 dark:border-white/5 bg-gradient-to-r from-[#0A3269]/5 to-transparent">
                  ...
                  {translatedPlans.map((plan) => (
                    ...
                    >
                      {plan.id === selectedPlan.id && (
                        <div className="absolute inset-x-0 top-0 h-0.5 bg-gradient-to-r from-[#0A3269]/60 via-[#0A3269] to-[#0A3269]/60" />
                      )}
                      <div className="flex flex-col items-center gap-0.5 sm:gap-1">
                        ...
                        {plan.popular && (
                          <Badge className="bg-gradient-to-r from-[#0A3269] to-[#0A3269]/80 text-white text-[6px] sm:text-[8px] px-1.5 sm:px-2 py-0.5 rounded-full font-light">
                    ...
                    <motion.tr
                      ...
                      className={cn(
                        ...
                        (benefit.id === 'personalCaseReviews' || benefit.id === 'statusChecks') && 
                          'bg-gradient-to-r from-[#0A3269]/5 to-transparent'
                      )}
                    >
          ...
          <motion.div 
            ...
            className="mt-3 h-px bg-gradient-to-r from-transparent via-[#0A3269]/20 to-transparent"
          />
        </motion.div>
            ...
            {allServices.map((service, idx) => (
              <motion.div
                ...
                className={cn(
                  ...
                  selectedPlan.popular 
                    ? 'border-[#0A3269]/20 bg-gradient-to-r from-[#0A3269]/5 to-transparent' 
        ...
        <motion.div
          ...
          className="mb-8 sm:mb-10 md:mb-12 p-4 sm:p-5 rounded-lg sm:rounded-xl border border-[#0A3269]/20 bg-gradient-to-r from-[#0A3269]/5 to-transparent"
        >
        ...
        >
          <div className="flex items-center justify-between mb-4 sm:mb-5 md:mb-6">
            ...
            <Badge 
              variant="outline" 
              className="text-[8px] sm:text-[10px] font-light border-[#0A3269]/30 text-[#0A3269] rounded-full px-2 sm:px-3 py-0.5 bg-[#0A3269]/5"
            >
              ...
              return (
                ...
                >
                  ...
                  <div className={cn(
                    ...
                    isPopular 
                      ? 'bg-gradient-to-r from-[#0A3269]/30 via-[#0A3269]/10 to-[#0A3269]/30' 
                  ...
                  {isPopular && (
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-10">
                      <Badge className="bg-gradient-to-r from-[#0A3269] to-[#1A4A8A] text-white px-4 py-1.5 rounded-full text-[10px] font-semibold shadow-lg shadow-[#0A3269]/20">
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <div className={cn(
                      ...
                      isPopular 
                        ? 'bg-gradient-to-br from-[#0A3269]/20 to-[#0A3269]/5' 
                        : 'bg-black/5 dark:bg-white/5 group-hover:bg-black/10 dark:group-hover:bg-white/10'
                    )}>
                      <PlanIcon className={cn(
                    ...
                    <div>
                      ...
                      {plan.popular && (
                        <p className="text-[11px] text-[#0A3269] font-light">
                  ...
                  <div className="mb-4">
                    ...
                    {plan.interval !== 'month' && (
                      <p className="text-xs text-[#0A3269] mt-1 font-medium">
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      isPopular
                        ? 'bg-white text-[#0A3269] border-2 border-[#0A3269]/20 hover:border-[#0A3269]/40 shadow-lg shadow-[#0A3269]/10'
                        : 'bg-white text-[#0A3269] border border-[#0A3269]/20 hover:border-[#0A3269]/40'
                    )}
                  >
                    {/* Shimmer Effect */}
                    <span className="absolute inset-0 -translate-x-full group-hover/btn:translate-x-full transition-transform duration-700 bg-gradient-to-r from-transparent via-[#0A3269]/10 to-transparent" />
          ...
          <motion.div 
            ...
            animate={{ width: '100%' }}
            transition={{ delay: 0.5, duration: 0.8 }}
            className="mt-6 sm:mt-8 h-px bg-gradient-to-r from-transparent via-[#0A3269]/20 to-transparent"
          />
        </motion.div>
      </div>
      ...
      <AnimatePresence>
        {showStickyBar && (
          <motion.div
            ...
            transition={{ duration: 0.3, ease: [0.22, 1, 0.36, 1] }}
            className="lg:hidden fixed bottom-0 inset-x-0 z-50 p-3 bg-white/90 dark:bg-black/90 backdrop-blur-lg border-t border-black/10 dark:border-white/10"
          >
            <div className="flex items-center justify-between gap-3">
              <div className="min-w-0">
                <p className="text-[10px] text-black/50 dark:text-white/50 font-light truncate">{selectedPlan.label}</p>
