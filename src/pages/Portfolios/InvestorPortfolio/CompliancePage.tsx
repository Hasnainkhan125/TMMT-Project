  ...
  return (
    <Layout>
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-2">
              <Button 
                ...
                disabled={isLoading}
                className="text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl"
              >
              ...
              <Button 
                ...
                className="bg-white dark:bg-black text-gray-900 dark:text-white border border-gray-200 dark:border-white/10 hover:bg-gray-50 dark:hover:bg-gray-900 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 rounded-xl"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {stats.map((stat, index) => (
              ...
              >
                <div className="border border-gray-200 dark:border-gray-800 rounded-2xl bg-white dark:bg-black p-6 shadow-sm hover:shadow-md transition-all duration-300">
          ...
          {/* Main Content Card */}
          <div className="border border-gray-200 dark:border-gray-800 rounded-2xl bg-white dark:bg-black overflow-hidden shadow-sm hover:shadow-md transition-all duration-300">
            {/* Tabs Header */}
                    ...
                    {tabItems.map((tab) => {
                      ...
                      return (
                        <button
                          ...
                          className={`
                            shrink-0 flex items-center gap-2.5 px-4 py-2.5 rounded-xl text-sm font-medium
                          ...
                          {userProfile?.documents && userProfile.documents.length > 0 ? (
                            userProfile.documents.map((doc: UserDocument, index: number) => {
                              ...
                              return (
                                ...
                                >
                                  <div className={`border rounded-xl p-4 ${getDocumentStatusColor(doc.status)}`}>
                    ...
                    <div className="space-y-6 max-h-[400px] overflow-y-auto pr-2">
                      ...
                      {businessData.hasCompany ? (
                        ...
                        <div className="text-center py-12">
                          ...
                          <Button onClick={() => setShowBusinessDialog(true)} className="bg-white dark:bg-black text-gray-900 dark:text-white border border-gray-200 dark:border-white/10 hover:bg-gray-50 dark:hover:bg-gray-900 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 rounded-xl">
                            <Plus className="w-4 h-4 mr-2" />
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                          {[
                            ...
                            <Button 
                              key={link.label}
                              variant="ghost" 
                              className={`justify-start text-gray-600 dark:text-gray-400 bg-gradient-to-br ${link.color} border border-gray-200/30 dark:border-white/5 rounded-xl px-4 py-2.5 hover:bg-gray-100 dark:hover:bg-white/5 transition-all duration-300`}
                                ...
                                <div className={`p-4 rounded-xl border ${
                                  ...
                                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                    ...
                                    <Button 
                                      ...
                                      } shadow-lg shadow-${doc.status === 'expired' ? 'rose' : 'amber'}-500/25 transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 rounded-xl`}
                                    >
                                      Renew Now
                                    </Button>
                                  </div>
      ...
      <Dialog open={showBusinessDialog} onOpenChange={setShowBusinessDialog}>
        <DialogContent className="bg-white dark:bg-black border border-gray-200/50 dark:border-white/10 max-w-2xl rounded-2xl shadow-2xl p-0 overflow-hidden">
          <div className="relative">
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#0D1F3C] via-[#1a2a4a] to-[#2D4A7A] dark:from-white dark:via-gray-200 dark:to-gray-300" />
            <DialogHeader className="p-6 pb-2">
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-xl bg-gradient-to-br from-[#0D1F3C]/10 to-[#1a2a4a]/10 dark:from-white/10 dark:to-white/5">
                  <Building2 className="h-5 w-5 text-[#0D1F3C] dark:text-white" />
                </div>
                <div>
                  <DialogTitle className="text-xl font-bold text-gray-900 dark:text-white">
          ...
          <div className="p-6 pt-4 space-y-5">
            <div className="flex items-center space-x-2 p-4 rounded-xl border border-gray-200/50 dark:border-white/10 bg-gray-50/50 dark:bg-white/5">
              <input
                type="checkbox"
              ...
              />
              <Label className="text-black dark:text-white font-medium">I have a company in UAE</Label>
            </div>
                ...
                >
                  <div>
                    ...
                    <Input
                      ...
                      className="bg-white dark:bg-black border-gray-200/50 dark:border-white/10 text-black dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-600 rounded-xl h-11 focus:ring-[#0D1F3C] dark:focus:ring-white"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    >
                      <SelectTrigger className="bg-white dark:bg-black border-gray-200/50 dark:border-white/10 text-black dark:text-white rounded-xl h-11 focus:ring-[#0D1F3C] dark:focus:ring-white">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        className="bg-white dark:bg-black border-gray-200/50 dark:border-white/10 text-black dark:text-white rounded-xl h-11 focus:ring-[#0D1F3C] dark:focus:ring-white"
                      />
                    </div>
                  </div>
                </motion.div>
            ...
            <div className="flex gap-3 pt-2">
              <Button onClick={handleUpdateBusiness} disabled={isLoading} className="flex-1 bg-[#0D1F3C] dark:bg-white text-white dark:text-[#0D1F3C] hover:bg-[#1a2a4a] dark:hover:bg-gray-200 rounded-xl h-11 shadow-lg shadow-[#0D1F3C]/25 dark:shadow-white/25 transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5">
